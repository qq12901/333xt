#!/usr/bin/env python
"""333交易系统 - Streamlit Cloud部署专用主入口
这个文件放在项目根目录，确保Streamlit Cloud能正常工作！
"""
import sys
...
st.markdown("""
    <style>
        ...
        h1 { color: #1e293b; font-weight: 700; padding-bottom: 1rem; }
        ...
        .stButton > button[kind="primary"] { background: linear-gradient(135deg, #10b981, #059669); border: none; }
        .dataframe { border-radius: 8px; overflow: hidden; }
        hr { border-color: #e2e8f0; margin: 1.5rem 0; }
        .stAlert { border-radius: 8px; }
        .stSlider > div > div > div > div { background: linear-gradient(90deg, #10b981, #3b82f6); }
        .stToggle > label > div { background: linear-gradient(135deg, #10b981, #059669); }
    </style>
